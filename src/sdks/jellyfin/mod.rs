...
pub enum SubtitleDeliveryMethod {
    /// External subtitle files (e.g. VTT/SRT)
    External,

    /// Embedded subtitle streams (e.g. MKV internal track)
    Embed,

    /// Subtitles delivered as part of an HLS stream
    Hls,
...
#[derive(EnumString, EnumDisplay, Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "PascalCase")]
pub enum ItemType {
    Movie,
    Series,
