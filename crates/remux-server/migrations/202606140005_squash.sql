...
INSERT OR IGNORE INTO media (id, title, kind, collection_kind, collection_media_kind, external_ids, promoted, created_at, updated_at) VALUES
    ...
    (x'a1b2c3d4000040008000000000000003', 'Music',       'collection', 'smart',  'music',      '{}', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (x'f47ac10b58cc4372a5670e02b2c3d479', 'Collections', 'collection', 'manual', 'collection', '{}', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (x'211d58cdf8504c74b4866f15480ebcc3', 'Playlists',   'collection', 'smart',  'playlist',   '{}', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
SELECT unhex(replace('df84acaa-fe34-4fe7-b826-15599646062e', '-', '')), 'TMDB',    '{"kind":"tmdb","config":{}}',                 '["meta","search"]',           '[]', 1, 0, strftime('%Y-%m-%dT%H:%M:%SZ', 'now'), strftime('%Y-%m-%dT%H:%M:%SZ', 'now') UNION ALL
