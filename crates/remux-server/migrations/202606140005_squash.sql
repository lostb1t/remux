...
INSERT OR IGNORE INTO media (id, title, kind, collection_kind, collection_media_kind, collection_smart_filter, collection_default_sort, collection_default_sort_order, collection_latest_auto_unplayed, collection_latest_sort_digital, external_ids, promoted, enabled, sort_order, created_at, updated_at) VALUES
    ...
    (x'f46d2385bf6f4ad689aa38232323731a', 'Top Netflix Movies', 'collection', 'smart',  'movie',      '{"match_mode":"all","groups":[{"match_mode":"all","rules":[{"field":"tag","op":"in","values":["provider:Netflix"]}]}]}', '["PopularityDay"]',      '["Descending"]', 0, 0, '{}', 1, 1, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (x'2f73513185424c75a57a4073e532e833', 'Top Netflix Shows',  'collection', 'smart',  'series',     '{"match_mode":"all","groups":[{"match_mode":"all","rules":[{"field":"tag","op":"in","values":["provider:Netflix"]}]}]}', '["PopularityDay"]',      '["Descending"]', 0, 0, '{}', 1, 1, 11, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
